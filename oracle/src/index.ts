...
const exampleTest = async (): Promise<void> => {
  ...
  await driver
    .findElement(By.css("td.bui-calendar__date[data-date='2021-05-13']"))
    .click(); //checkin
  await driver
    .findElement(By.css("td.bui-calendar__date[data-date='2021-05-18']"))
    .click(); //checkout
  ...
  await driver
    ...
    .click(); //automated click for + adults
  ...
  await driver
    ...
    .click(); //automated click for + children
  //await driver.findElement(By.css("button[aria-label='Decrease number of Children']")).click();//automated click for - children
  //=====No of Rooms
  await driver
    .findElement(By.css("button[aria-label='Increase number of Rooms']"))
    .click(); //automated click for + rooms
  ...
  try {
    ...
    console.log(
      'Test-2 Result: Passed! Successfully load hotels in ' + destination
    );
  } catch (e) {
    console.log(
      'Test-2 Result: Failed! Failed to load hotels in ' + destination
    );
  }
};
